  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-12 sm:mb-16">
        <h2 className="text-2xl sm:text-4xl font-bold text-white tracking-tight">PROJECTS</h2>
        ...
        {(showAll ? projects : projects.slice(0, 3)).map((project) => (
          ...
          >
            <div
              ...
              className="border border-white/10 bg-gray-900/80 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden cursor-pointer hover:shadow-purple-500/30 hover:-translate-y-2 transition-transform duration-300 h-full"
            >
              <div className="p-4">
                <img
                  src={project.image}
              ...
              <div className="p-5 sm:p-6">
                ...
                <p className="text-gray-400 mb-4 pt-2 text-sm sm:text-base line-clamp-3 leading-relaxed">
                  {project.description}
                </p>
                <div className="mb-4">
